    ...
    return (
        <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-ambient bg-[var(--color-surface-white)]">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                {/* Google Login */}
                <button className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-[var(--color-surface-container)] text-sm font-medium text-[var(--color-foreground)] hover:bg-[var(--color-surface-container-high)] transition-colors duration-300 mb-8">
